    ...
    let info = json!({
        ...
        "commands": {
            ...
            "compose": {
                ...
                "draft create | new": "Create local draft (autosave-friendly: recipient/body may be empty; same compose flags as send, plus --reply-to or --reply-to-msg)",
                "draft list | ls": "List drafts (--account)",
                "draft show <id>": "Show draft content",
                "draft edit <id>": "Edit draft (--account/--from, --subject, --text, --html, --to, --cc, --bcc, --attach to replace, --clear-attachments)",
            ...
            "inbox": {
                ...
                "inbox list | ls": "List messages (--account, --limit, --unread, --archived, --starred, --snoozed, --after <cursor>). Pagination: --after <id> returns {messages, has_more, next_cursor}",
                ...
                "inbox search <query>": "Search messages (--account, --limit, --from, --to, --subject, --has-attachment, --unread, --starred)",
                "inbox star <ids...> | inbox unstar <ids...>": "Toggle starred state for one or more messages",
                "inbox snooze <ids...> --until <time> | inbox unsnooze <ids...>": "Hide messages until a time, or restore them",
                "inbox unsubscribe <id>": "Resolve a List-Unsubscribe URL/mailto for a message",
            ...
            "delivery": {
                "outbox list | ls": "List durable outbox items",
